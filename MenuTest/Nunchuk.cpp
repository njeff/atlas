...
uint32_t Nunchuk::yTime(){
	return yt;
}

uint32_t Nunchuk::xTime(){
	return xt;
}

uint32_t Nunchuk::cTime(){
	return ct;
}

uint32_t Nunchuk::zTime(){
	return zt;
}

bool Nunchuk::getChangeZ(){
	return changez;
}

bool Nunchuk::getChangeC(){
	return changec;
}
